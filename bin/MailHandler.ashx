...
public class Handler : IHttpHandler {
	public void ProcessRequest (HttpContext context) {
		...
		messageBody += "<br>\n";
		messageBody += "<p>Email Adress: " + context.Request.Form.Get("email") + "</p>\n";
		messageBody += "<br>\n";
		messageBody += "<p>Phone Contact: " + context.Request.Form.Get("phone") + "</p>\n";
		messageBody += "<br>\n";
		messageBody += "<p>Messager: " + context.Request.Form.Get("message") + "</p>\n";
